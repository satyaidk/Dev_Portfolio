  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "nikadisatyanarayana@gmail.com",
      link: "mailto:nikadisatyanarayana@gmail.com",
    },
    {
  ...
  const socialLinks = [
    {
      ...
      name: "LinkedIn",
      link: "https://www.linkedin.com/in/nikadisatyanarayana",
    },
    {
      icon: <Github className="h-5 w-5" />,
      name: "GitHub",
      link: "https://github.com/satyaidk",
    },
    {
      icon: <Twitter className="h-5 w-5" />,
      name: "Twitter",
      link: "https://x.com/Satya_Idk",
    },
  ]
